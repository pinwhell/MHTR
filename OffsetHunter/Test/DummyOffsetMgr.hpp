...
struct OffMgr {
	...
	struct BinArm32A {
		...
		uintptr_t name4 = 0x8;	 // Should be 0x8
	...
	mBinArm32A.name4 = obj["-1881508668"].asUInt();	 // Should be 0x8
	...
	mBinArm32B.name2 = obj["-99367283"].asUInt();	 // Should be 0x8
	mBinArm32B.name4 = obj["-1374760517"].asUInt();	 // Should be 0x8
	mBinArm32B.name3 = obj["-737063900"].asUInt();	 // Should be 0x8
#endif

#if defined(ARM64)
	mBinArm64A.name1 = obj["462494170"].asUInt();	 // Should be 0x8
	mBinArm64A.name2 = obj["-175202447"].asUInt();	 // Should be 0x8
	mBinArm64A.name4 = obj["-643990041"].asUInt();	 // Should be 0x8
	...
	mBinArm64B.name4 = obj["1098933040"].asUInt();	 // Should be 0x8
